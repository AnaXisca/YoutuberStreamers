...
public class CustomListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        final TextView tvChannelTitle=(TextView)convertView.findViewById(R.id.video_channelTitle);
        final  TextView tvPublishedAt=(TextView)convertView.findViewById(R.id.video_publishedAt);
       ...
       ((LinearLayout) convertView.findViewById(R.id.asser)).setOnClickListener(new View.OnClickListener() {
        ...
        VideoDetails videoInfo = (VideoDetails) this.singletons.get(i);
        networkImageView.setImageUrl(videoInfo.getURL(), this.imageLoader);
        tvVideoID.setText(videoInfo.getVideoId());
        imgtitle.setText(videoInfo.getVideoName());
        imgdesc.setText(videoInfo.getVideoDesc());
        tvChannelTitle.setText(videoInfo.getChannelTitle());
        tvPublishedAt.setText(videoInfo.getPublishedAt());
        return convertView;
    }
}
