...
import social.butterfly.streamers.R;
...
public class MainActivity extends AppCompatActivity {
   ...
   String TAG="MainActivity";
    ...
    private void showVideo() {
        ...
        String URL="https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q="+searchName+"&key=AIzaSyCHIH-5sdPv1LMVbY7olEyBKIDG9T41Kvg&type=video&eventType=live";
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        videoDetails.setChannelTitle(channelTitle);
